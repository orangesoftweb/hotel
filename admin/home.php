                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Estado <small>Reserva de habitacion </small>
                        </h1>
                    </div>
                </div>
                <!-- /. ROW  -->
									...
									<div class="panel panel-primary">
										<div class="panel-heading">
											<h4 class="panel-title">
												...
												<button class="btn btn-default" type="button">Nueva reserva de habitaciones
											...
											{		
												...
												if($br=="Conform")
												{
													...
													<div class='panel panel-primary text-center no-boder bg-color-blue'>
														...
														<a href=show.php?sid=".$fid ."><button  class='btn btn-primary btn' data-toggle='modal' data-target='#myModal'> Show
														</button></a>
															".$mrow['TRoom']."
														</div>
													</div>	
									...
									<div class="panel panel-danger">
										<div class="panel-heading">
											<h4 class="panel-title">
												...
												<button class="btn btn-primary" type="button"> Followers  <span class="badge"><?php echo $f ; ?></span>
												</button>
												</a>
											</h4>
										</div>
				...
				<div class='modal fade' id='myModal' tabindex='-1' role='dialog' aria-labelledby='myModalLabel' aria-hidden='true'>
					<div class='modal-dialog'>
						<div class='modal-content'>
							...
							<div class='modal-body'>
								<div class='form-group'>
								<label>Cambia la contraseña </label>
